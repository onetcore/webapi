...
namespace Yd.Extensions.Security.Data
{
    ...
    public class UserStore : UserStoreBase<User, Role, UserClaim, UserRole, UserLogin, UserToken, RoleClaim>
    {
        ...
        public UserStore(IdentityErrorDescriber describer, IDbContext<User> userContext, IDbContext<UserClaim> userClaimContext, IDbContext<UserLogin> userLoginContext, IDbContext<UserToken> userTokenContext, IDbContext<Role> roleContext, IDbContext<UserRole> userRoleContext, IDbContext<RoleClaim> roleClaimContext, IServiceProvider serviceProvider)
            : base(describer, userContext, userClaimContext, userLoginContext, userTokenContext, roleContext, userRoleContext, roleClaimContext, serviceProvider)
        {
        }
    }
}