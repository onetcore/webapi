...
using Yd.WebUI.Properties;

namespace Yd.WebUI.Core.TagHelpers.Bootstraps
{
    /// <summary>
    /// 下拉框标签。
    /// </summary>
    [HtmlTargetElement("gt:page-dropdownlist")]
    public class PageDropdownListTagHelper : ViewContextableTagHelperBase
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            for (var i = 1; i <= Data.Pages; i++)
            {
                ...
                builder.InnerHtml.AppendHtml(string.Format(Resources.PageTagHelper_NumberPage, i));
                if (i == page)
